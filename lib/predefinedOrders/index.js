...
// EBICS 3.0 (H005) key management. Only INI/HIA/HPB are implemented for
// H005 so far (see lib/orders/H005/serializer.js and
// node-ebics-client-h005-scoping.md for what's not yet built - business
// order upload/download types need the BTF schema confirmed first).
const H005INI = require('./h005/INI');
const H005HIA = require('./h005/HIA');
const H005HPB = require('./h005/HPB');
