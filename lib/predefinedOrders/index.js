...
// EBICS 3.0 (H005). Key management (INI/HIA/HPB), BTD statement download
// (Z53) and BTU payment upload (CCT) are implemented - see
// lib/orders/H005/serializer.js and docs/EBICS-3.0-H005.md.
const H005INI = require('./h005/INI');
const H005HIA = require('./h005/HIA');
const H005HPB = require('./h005/HPB');
const H005Z53 = require('./h005/Z53');
const H005CCT = require('./h005/CCT');
