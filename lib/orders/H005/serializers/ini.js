...
// and optional TimeStamp, is the *raw-key* representation only). CONFIRMED
// against the real EBICS 3.0 schema files (ebics_signature_S002.xsd's
// PubKeyInfoType = { ds:X509Data } only; ebics_types_H005.xsd's
// Authentication/EncryptionPubKeyInfoType both extend it directly) -
// EBICS Working Group, October 2016. An earlier version of this code nested
// X509Data inside a PubKeyValue wrapper (invalid against this type family)
// and was rejected outright by PostFinance's EBICS 3.0 test server with a
// schema-validation-level HTTP 400, before any EBICS-level processing.
...
// namespace changes to 'http://www.ebics.org/S002' - CONFIRMED against the
// real ebics_signature_S002.xsd (targetNamespace="http://www.ebics.org/S002"),
// not just the Common Implementation Guide.
