...
// Same normalized form (newlines stripped) that encryptedOrderData() below
// deflates and transmits, so this is the digest of the exact bytes the
// bank will end up with after decrypting OrderData in the transfer phase.
const documentDigest = document => Crypto.digestWithHash(document.replace(/\n|\r/g, ''));
